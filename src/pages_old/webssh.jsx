  ...
  render() {
    return (
      <>
        <Text
          h4
          style={{ fontFamily: "'Cascadia Code','Fira Code','Consolas', 'IBM Plex Mono', 'Ubuntu Mono', 'monospace'" }}>
          >_ Monica webSSH</Text>
        <div id="monica" style={{ padding: '1rem', borderRadius: '.5rem', backgroundColor: 'black' }}></div>
      </>
    )
  }
}
